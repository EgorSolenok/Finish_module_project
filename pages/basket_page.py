...
#Метод, ожидающий того, что корзина пустая - элементов покупок нету. Если есть (лимит поиска 4 сек) - падает с ошибкой

    def should_not_be_basket_items(self):
        assert self.is_not_element_present(*BasketPageLocators.BASKET_ITEMS), \
        "Basket items is presented, but should not be"
        
#Метод, проверяющий сообщение о пустой корзине. Реализован для русского и английского языка интерфейса
